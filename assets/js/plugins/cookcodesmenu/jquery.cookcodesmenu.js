...
(function ($, document, window) {
    var
        ...
        defaults = {
            ...
            brand: '<div style="display: none;">LOGO</div>', // Supports HTML
            label: '<span class="butter-span"><span></span><span></span><span></span></span>Все услуги', // Menu Label: // Supports HTML
            duplicate: true,
            duration: 200,
            easingOpen: 'swing',
            easingClose: 'swing',
            closedSymbol: "<i class='fas fa-angle-down'></i>", //Supports HTML
            openedSymbol: "<i class='fas fa-angle-up'></i>", //Supports HTML
            prependTo: 'body',
            appendTo: '.cookcodesmenu-bar',
            parentTag: 'a',
            closeOnClick: true,
